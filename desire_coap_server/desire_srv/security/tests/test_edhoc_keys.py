"""EDHOC keys utilities test module."""
...
def test_write_edhoc_credentials(tmp_path):
    ...
    edhoc_keys.write_edhoc_credentials(authkey, authkey_path, authcred_path)
...
def test_rmv_peer_cred(tmp_path):
    path = tmp_path / "peercred"
    cred1 = b"\xd3<\x1e\xd5\x83\xda?\x17j\xdd\xf3\xad@\xf93\xbe\xf0\xe8\x88\xec\x8f:\x8dcNbL\x82zh\xd9"  # noqa: E501
    cred2 = b"`_\xf95\xe8n\xd9\xaaJw2 \x0b\xde\xe0\x9a\x9f\xa2XV,\xd0\x90x\x0eqE5\xb1v\xccZ"  # noqa: 501
    assert edhoc_keys.add_peer_cred(cred1, b"20", path)
    assert edhoc_keys.add_peer_cred(cred2, b"21", path)
...
def test_get_peer_cred(tmp_path):
    path = tmp_path / "peercred"
    cred1 = b"\xd3<\x1e\xd5\x83\xda?\x17j\xdd\xf3\xad@\xf93\xbe\xf0\xe8\x88\xec\x8f:\x8dcNbL\x82zh\xd9"  # noqa: E501
    cred2 = b"`_\xf95\xe8n\xd9\xaaJw2 \x0b\xde\xe0\x9a\x9f\xa2XV,\xd0\x90x\x0eqE5\xb1v\xccZ"  # noqa: E501
    assert edhoc_keys.add_peer_cred(cred1, b"20", path)
    assert edhoc_keys.add_peer_cred(cred2, b"21", path)
